    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            if (CurrentVersion != OnlineVersion) // If the current version is not equal to the value online
            {
                ...
                WebStuff.DownloadFile("https://github.com/Ukn0wnUs3rn4m3/xMainDab/blob/main/xProjectDAB/raw/main/MainDab%20Updater.exe", "MainDabUpdater.exe");
                WebStuff.Dispose();
        ...
        {
            string penis = WebStuff.DownloadString("https://raw.githubusercontent.com/Ukn0wnUs3rn4m3/xMainDab/main/update/staffUpdate/Notice");
